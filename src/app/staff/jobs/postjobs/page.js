...
const Page = () => {
  ...
  const [jobDescriptionRecommendation, setJobDescriptionRecommendation] =
    useState();
  const [isAiTriggered, setIsAiTriggered] = useState(false);

  const getDescriptionRecommendation = async () => {
    try {
      setIsAiTriggered(true);

      const response = await axios.post(
        BaseAPI + "/admin/jobs/get-job-description",
      ...
      setJobDescriptionRecommendation(response.data.generated_text);
    } catch (error) {
      setIsAiTriggered(false);
  ...
  const handleKeyDown = (e) => {
    if (e.key === "Tab") {
      ...
      setUserData({
        ...userData,
        job_description: jobDescriptionRecommendation,
      });
    }
  };
  ...
  //   setUserData((prev) => {
  //     // If changing a custom_section field
  //     if (index !== null) {
  //       const updatedCustomSection = [...prev.custom_section];
  //       updatedCustomSection[index] = {
  //         ...updatedCustomSection[index],
  //         [name]: value,
  //       };
  ...
  //       return {
  //         ...prev,
  //         custom_section: updatedCustomSection,
  //       };
  //     }
    ...
    try {
      ...
      if (Object.keys(newErrors).length === 0) {
        ...
        if (confirmationResult.isConfirmed) {
          ...
          const updatedData = {
            ...userData,
            skill: selectedSkills.map((item) => item.value).join(","),
              ...
              <div className="col-md-9 addJobRightSection  px-3 py-3">
                <form>
                  <div className="bg-white py-3 px-3 rounded-md ">
                    <div
                      className="rightSectionHeading border-b-2  py-2 text-xl text-dark"
                      ref={jobDetailsRef}
                    >
                      Job Details
                    </div>
                    ...
                    <div class="mb-3 mt-3">
                      ...
                      >
                        ...
                        <textarea
                          ...
                          rows="7"
                          placeholder={
                            jobDescriptionRecommendation || "Job Description"
                          }
                          value={userData.job_description}
                          onChange={handleChange}
                          onKeyDown={handleKeyDown}
                          name="job_description"
                          onFocus={getDescriptionRecommendation} // Call function on click
                        />
                  ...
                  <div className="bg-white py-3 px-3 my-4 rounded-md ">
                    ...
                    <label for="exampleInputEmail1" class="form-label">
                      Qualification<span className="Manadorty">*</span>
                    </label>
                    <select
                      class="form-select"
                      aria-label="Default select example"
                  ...
                  <div className="bg-white py-3 px-3 my-4 rounded-md ">
                    <div class="mb-3 mt-3">
                      <label for="exampleInputEmail1" class="form-label">
                        Select process<span className="Manadorty">*</span>
                      </label>
                      <Select
                        isMulti
                        isSearchable
                  ...
                  <div className="">
                    ...
                    <Link href="/employer/jobs" className="btn button2">
                      Cancel
                    </Link>
                  </div>
                </form>
                ...
                <div className="bg-white p-3 rounded-md fixed">
                  ...
                  <div className="row p-3">
                    <div className="col-lg-12 col-md-6">
                      <div className="my-1">
                        <button
                          className="btn btn-info btn-Jobs  w-full  "

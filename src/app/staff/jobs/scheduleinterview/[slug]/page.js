...
const Page = ({ params }) => {
  ...
  //     // Update userData with user_assigned before proceeding
  //     const updatedUserData = {
  //       ...userData,
  //       user_assigned: userId,
  //     };
  ...
  //     let staffData =  getStaffAvailability(updatedUserData.start_time);
  ...
  //     // Ensure the update is applied before using userData
  //     setExistingInterviewDetails((prevDetails) => [
  //       ...prevDetails,
  //       updatedUserData,
  //     ]);

  //     console.log(updatedUserData, "user data after update");
  //   }

  //   // Ensure all required fields are filled before showing the preview button
  //   if (
  //     userData.duration !== "" &&
  //     userData.interview_type !== "" &&
  //     userData.interview_type_detail !== "" &&
  //     userData.process_id !== "" &&
  //     userData.start_time !== "" &&
  //     selectedUsers.length > 0 // Check selectedUsers instead of user_assigned
  //   ) {
  //     setShowPreviewButton(true);
  //   } else {
  //     setShowPreviewButton(false);

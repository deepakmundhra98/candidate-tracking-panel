...
const handleChange = (e) => {
  ...
  const getData = async () => {
    try {
      ...
      const event = new CustomEvent('profileDataLoaded', { detail: { profile_picture: response.data.response.profile_picture, website_logo: response.data.response.website_logo }});

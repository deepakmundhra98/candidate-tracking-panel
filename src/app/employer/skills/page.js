...
const Page = () => {
  ...
  const handleMultipleDelete = async () => {
    try {
      ...
      if (confirmationResult.isConfirmed) {
        ...
        console.log("Deletion was canceled by the user.");
      }
    } catch (error) {
      setLoading(false);
      Swal.fire({
  ...
  const rows = skills
    ? skills.map((i) => ({
        ...
        skill_type: i.employer_id === 0 ? "System Generated" : "Custom",
        Name: i.skill_name,
        createdat: i.created,
        status: i.status,
        slug: i.slug,
    ...
    : userData.map((item) => ({
        ...
        skill_type: item.employer_id === 0 ? "System Generated" : "Custom",
        ...
        >
          ...
          <div className="">
            <div className="serachKeyItems  bg-white">
              <form action="">
                <p>Search Skill by Skill Name</p>
                <div className="flex flex-col md:flex-row justify-between items-center w-full md:gap-4">
                  ...
                  <div className="add__interviewwww">
                    <Link
                      href="/employer/skills/addskills"

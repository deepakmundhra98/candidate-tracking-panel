...
const Page = () => {
  ...
  const userId = Cookies.get("employerId");
  ...
  const handleReschedule = async (
    ...
    router.push("/employer/interview/reschedule/" + candidate_id);
  };
      ...
      renderCell: (params) => (
        <strong>
          <div className="process__actionnn" style={{ margin: "10px 0" }}>
            ...
            {params.row.interview_completion_status === null &&
              params.row.interview_cancellation_status !== "1" && (
                <>
                  <button
  ...
  const rows =
    skills?.length > 0
      ? skills.map((item, index) => ({
          ...
          interviewer: item.user_assigned,
      ...
      <EmployerLayout>
        ...
        >
          ...
          <div className="">
            ...
            {/* <Modal show={jobModal} onHide={handleCloseJobModal}>
              <Modal.Header closeButton className="bg-red-500 text-white">
                <Modal.Title>{JobModalData?.job_name}</Modal.Title>
              </Modal.Header>
              <Modal.Body>
                {JobModalData && (
                  <div>
                    <div className="dDrt">
                      <span>Job Name: </span>
                      {JobModalData && JobModalData.job_name}
                    </div>
                    <div className="dDrt">
                      <span>Category: </span>
                      {JobModalData.category ? JobModalData.category : "N/A"}
                    </div>
                    <div className="dDrt">
                      <span>Designation: </span>
                      {JobModalData && JobModalData.designation}
                    </div>
                    <div className="dDrt">
                      <span>Job Posted Date :</span>
                      {JobModalData && JobModalData.job_created_at}
                    </div>

                    <div className="dDrt">
                      <span>Location : </span>
                      {JobModalData && JobModalData.location
                        ? JobModalData.location
                        : "N/A"}
                    </div>
                    <div className="dDrt">
                      <span>Experience : </span>
                      {JobModalData.min_exp} - {JobModalData.max_exp} Years
                    </div>
                    <div className="dDrt">
                      <span>Annual Salary : </span>
                      {JobModalData.min_salary} - {JobModalData.max_salary}
                    </div>
                    <div className="dDrt">
                      <span>Skills : </span>
                      {JobModalData.skill}
                    ...
                    <div className="dDrt">
                      <span>Work Type : </span>
                      {JobModalData.work_type}
                    </div>
                    <div className="dDrt">
                      <span>Interview Process : </span>
                      <ul>
                        {JobModalData.process_order !== ""
                          ? JobModalData.process_order
                              ?.split(",")
                    ...
                    <div className="dDrt">
                      ...
                      {JobModalData && JobModalData.job_description
                        ? HTMLReactParser(JobModalData.job_description)
                        : "N/A"}
                    </div>
                  </div>
                )}

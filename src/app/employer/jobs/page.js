...
const Page = () => {
  ...
  const columns = [
    { field: "job_name", headerName: "Job Title", width: 250, flex: 1 },
    {
      ...
      renderCell: (params) => (
        <strong>
          <div className="process__actionnn" style={{ margin: "10px 0" }}>
            ...
            <Link
              href={`/employer/jobs/edit/${params.row.slug}`}
            ...
            <Link
              href={`/employer/jobs/applied-candidate-list/${params.row.id}`}
              className="btn  btn-danger btn-smmm"

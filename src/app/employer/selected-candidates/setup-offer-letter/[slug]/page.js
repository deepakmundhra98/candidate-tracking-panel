      ...
      if (Object.keys(newErrors).length === 0) {
        ...
        if (confirmationResult.isConfirmed) {
          ...
          if (response.data.status === 200) {
            router.push("/employer/selected-candidates");
            Swal.fire({
            ...
            <div className="breadCumb1" role="">
              <div className="flex gap-3 flex-wrap items-center">
                ...
                <div className="flex gap-2 items-center  ">
                  ...
                  <span>
                    {" "}
                    <Link href="/employer/selected-candidates">
                      {" "}
                      Selected Candidates{" "}
                    </Link>{" "}
                  </span>
          ...
          <div className="addInterviewProcessForm">
            ...
            <div className="bottomButtons">
              ...
              {pageData.draft_status !== "1" && (
                <button className="min-w-[180px] btn button1" onClick={saveDraft}>
                  Save as Draft
                </button>
              )}
              {pageData.draft_status === "1" && displayDraftButton && (
                <button
                  className="w-fit btn button1"
                  onClick={saveDraft}
                  style={{
                    color: "#ffffff",

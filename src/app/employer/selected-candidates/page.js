...
const Page = () => {
  ...
  const handleOfferLetterSetup = (job_id, candidateId) => {
    ...
    router.push(
      `/employer/selected-candidates/setup-offer-letter/${candidateId}`
    );
  };
        ...
        <strong>
          <div className="process__actionnn" style={{ margin: "10px 0" }}>
            ...
            {params.row.on_boarding_completion_status	 === "1" && (
              <Link
                href={`/employer/selected-candidates/show-onboarding-details/${params.row.candidateId}`}
                variant="primary"
                onClick={(e) => {
                  e.stopPropagation();
                }}
                    ...
                    return (
                      <>
                        ...
                        <div className="dDrt">
                          ...
                          {i.duration} {i.duration === "1" ? "Hour" : "Minutes"}
                        </div>
                        <div className="dDrt">
                          <span>Comment : </span>
                          {i.comment}

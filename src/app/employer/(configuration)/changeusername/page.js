...
const Page = () => {
  ...
  // useEffect(() => {
  //   const sidebarDisplay = sessionStorage.getItem("sidebarDisplay");
  //   // Convert string to boolean
  //   setSidebarDisplay(sidebarDisplay);
  //   console.log(sidebarDisplay,"sidebar")
  // }, [sidebarDisplay]);
          ...
          <div className="breadCumb1" role="">
            <div className="flex gap-3 items-center">
              ...
              <div className="flex gap-2 items-center  ">
                ...
                <span>Change Company Username</span>
              </div>
            </div>
          </div>
            ...
            <div className="profilelogochange">
              ...
              <div className="mb-3">
                <label htmlFor="formGroupExampleInput2" className="form-label">
                  New Username <span className="text-danger">*</span>
                </label>
                <input
                  type="text"
                  className="form-control"
              ...
              <div className="mb-3">
                <label htmlFor="formGroupExampleInput2" className="form-label">
                  Confirm Username <span className="text-danger">*</span>
                </label>
                <input
                  type="text"
                  className="form-control"

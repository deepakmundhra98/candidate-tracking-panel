    ...
    try {
      ...
      if (Object.keys(newErrors).length === 0) {
        const confirmationResult = await Swal.fire({
          title: "Add?",
          text: "Do you want to add this currency name?",
          icon: "question",
        ...
        if (confirmationResult.isConfirmed) {
          ...
          const response = await axios.post(
            BaseAPI + `/admin/currencies/currencyadd`,
            userData,
            {
              headers: {
          ...
          if (response.data.status === 200) {
            Swal.fire({
              title: "Currency name added successfully!",
              icon: "success",
              confirmButtonText: "Close",
            }).then(() => {
              router.push("/employer/currencies");
            });
      ...
      Swal.fire({
        title: "Failed",
        text: "Could not add currency name",
        icon: "error",
        confirmButtonText: "Close",
      });
    }
              ...
              <div className="row">
                ...
                <div className="col-lg-10 col-md-10 col-sm-10 Name--txt">
                  <div className="buttomButtons">
                    ...
                    <Link href="/employer/currencies" className="themeButton2">
                      Cancel
                    </Link>
                  </div>
                </div>

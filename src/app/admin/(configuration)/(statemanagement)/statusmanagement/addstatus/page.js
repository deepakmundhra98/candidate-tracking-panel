    ...
    try {
      ...
      if (confirmationResult.isConfirmed) {
        ...
        if (response.data.status === 200) {
          ...
          window.scrollTo(0, 0);
          router.push("/admin/statusmanagement")
    ...
    <>
        ...
        <div className="breadCumb1" role="">
                <div className="flex gap-3 items-center">
                  ...
                  <Link href="/admin/statusmanagement" className="flex gap-2 items-center  ">
                    <i class="fa-solid fa-user"></i>
                    <span> Manage Staus <i class="fa-solid fa-angles-right text-xs"></i></span>
                  </Link>
                  <div className="flex gap-2 items-center  ">
        ...
        <div className="addInterviewProcessForm" style={{minHeight: "60vh"}}>
            <div className="row">
              ...
              <div className="col-md-10 rightSide">
                ...
                <div className="bottomButtons">
                  ...
                  <Link href ="/admin/statusmanagement" className="btn button2">Cancel</Link>
                </div>
              </div>
            </div>
          </div>

            ...
            <div className="flex gap-3 items-center">
              ...
              >
                <div className="flex gap-2 items-center">
                  ...
                  <span>Dashboard <i class="fa-solid fa-angles-right text-xs"></i></span>
                </div>
              </Link>
              <div className="flex gap-2 items-center  ">
              ...
              <div className="profilelogochange">
                ...
                <div className='mb-3'>
                  ...
                  <div className=' w-32 h-32 rounded-lg border-2 shadow-sm'>
                    {selectedImage ? (
                      <img src={selectedImage} alt="selected logo" height={200} width={200} />
                    ) : (
                      <img
                  ...
                  <div className="bottomButtons">
                    <button className="btn button1" onClick={handleClick}>Save</button>
                    <Link href="/admin/dashboard" className="btn button2">Cancel</Link>
                  </div>
                </div>
              </div>
            </div>

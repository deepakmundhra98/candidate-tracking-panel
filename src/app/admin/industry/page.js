    ...
    try {
      ...
      if (confirmationResult.isConfirmed) {
        ...
        if (response.data.status === 200) {
          ...
          Swal.fire({
            title: response.data.message,
            text: response.data.system_generated_skills.map((i) => {
              return i.name + ", ";
            }).join(""),
            icon: "warning",
            confirmButtonText: "Close",
          ...
          <div className=" backgroundColour">
            ...
            <div className="add--processs">
              <div className="add__interviewwww">
                <Link href="/admin/industry/add" className="btn btn-addAdmin ">
                  Add Industry
                </Link>
              </div>
            </div>
              ...
              <form action="">
                ...
                <div className="flex flex-col md:flex-row">
                  ...
                  <div className="flex flex-col md:flex-row md:h-11 items-center">
                    ...
                    <button className="btn btn-clearFilters" onClick={handleClearFilters}>
                      Clear Filters
                    </button>
                  </div>
                </div>
